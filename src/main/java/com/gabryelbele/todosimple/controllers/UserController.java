...
import com.gabryelbele.todosimple.models.User.CreateUser;
import com.gabryelbele.todosimple.models.User.UpdateUser;
...
public class UserController {
    ...
    public ResponseEntity<Void> update(@Valid @RequestBody User obj, @PathVariable(value = "id") Long id) {
        obj.setId(id);
